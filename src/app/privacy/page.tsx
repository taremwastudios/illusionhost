...
export default function PrivacyPage() {
  return (
    <div style={{
      ...
      <p style={{ marginBottom: "1.5rem" }}>Effective date: 2026-02-27</p>

      <h3><b>1. Introduction</b></h3>
      <p>Welcome to <b>Illusionhost</b>.</p>
      <p>
      ...
      <p><b>SERVICE</b> means the illusionhost.net website operated by Illusionhost.</p>
      ...
      <p>If you are located outside Frankfurt and choose to provide information to us, please note that we transfer the data, including Personal Data, to Frankfurt and process it there.</p>
      ...
      <h4><b>0.1. Disclosure for Law Enforcement.</b></h4>
      ...
      <h4><b>0.2. Business Transaction.</b></h4>
      ...
      <h4><b>0.2. To delete your personal information.</b></h4>
      ...
      <h4><b>0.3. To stop selling your personal information.</b></h4>
      ...
      <p>To exercise your California data protection rights described above, please send your request(s) by email: <b>support@illusionhost.co</b>.</p>
      ...
      <h3><b>19. Children's Privacy</b></h3>
      ...
      <p>If you have any questions about this Privacy Policy, please contact us by email: <b>support@illusionhost.net</b>.</p>
    </div>
  );
}
