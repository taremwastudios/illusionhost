    ...
    <>
      ...
      <section className="hero">
        <div className="hero-content">
          <h1>
            The Domain <span style={{ background: "linear-gradient(135deg, #a78bfa 0%, #f59e0b 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>Powerhouse</span>
          </h1>
